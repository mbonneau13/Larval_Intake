function [Risk , Polution_tp1 , Polution_plus] = Simu_Trajectory(nq,F_W1,F_W2,Week_Time,nGoats,mu_wf,sigma_wf,mu_np,sigma_np,Evap,Precipitation,Temperature,T_Zone,ZN,OPG_Goats,W,Spec)
...
[Polution_t , Polution_plus] = Simu_FecesDrop(nGoats,nq,mu_wf,sigma_wf,mu_np,sigma_np,G_Time,gt,OPG_Goats);

%% Simulate eggs development to L3
Polution_tp1 = Simu_Larva(Polution_t,Temperature,Evap,Precipitation);
x = Polution_tp1./Polution_t;
x(isnan(x)) = 0;
Polution_plus = Polution_plus.*repmat(x,[25 , 1]);
